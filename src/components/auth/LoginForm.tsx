                    ...
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div className="hidden lg:flex flex-col items-center justify-center space-y-3">
                            ...
                            <div className="text-center space-y-2 max-w-md">
                                <h2 className="text-2xl font-bold text-[#EAF2FF]">Welcome back</h2>
                                <p className="text-base text-[#A9B4CA]">Pick up where you left off</p>
                        ...
                        <div className="w-full max-w-md mx-auto lg:mx-0">
                            ...
                            <div className="lg:hidden text-center mb-6">
                                ...
                                <h2 className="text-xl font-bold text-[#EAF2FF] mb-1">Welcome back</h2>
                                <p className="text-sm text-[#A9B4CA]">Pick up where you left off</p>
                            </div>
                            ...
                            <div className="bg-[rgba(255,255,255,0.07)] backdrop-blur-[10px] rounded-3xl p-6 shadow-[0_8px_32px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.05)] border border-[#233047]">
                                ...
                                <div className="mb-3.5 hidden lg:block">
                                    <h1 className="text-2xl font-bold text-[#EAF2FF] mb-1">Welcome back</h1>
                                    <p className="text-sm text-[#A9B4CA]">Pick up where you left off</p>
                                </div>
                                ...
                                <form onSubmit={handleEmailPasswordLogin} className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-right mt-1.5">
                                            <a href="/forgot-password" className="text-xs text-[#a8d5d5] hover:text-[#f5e6d3] transition-colors focus:outline-none focus:ring-2 focus:ring-[#a8d5d5]/40 rounded">
                                                Forgot password?
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    >
                                        {loading ? 'Signing in...' : isFormValid ? 'Sign in' : 'Enter email and password'}
                                    </Button>

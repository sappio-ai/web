                            ...
                            <div className="space-y-6 max-w-md relative z-10">
                                ...
                                <div className="space-y-3">
                                    <h2 className="text-[36px] font-bold text-[#1A1D2E] leading-[1.15] tracking-[-0.02em]" style={{ fontFamily: 'var(--font-geist-sans)' }}>
                                        Welcome back to <span className="relative inline-block">
                            ...
                            <div className="relative">
                                ...
                                <div className="relative bg-white rounded-xl shadow-[0_2px_12px_rgba(15,23,42,0.08),0_1px_3px_rgba(15,23,42,0.06)] border border-[#94A3B8]/30 transition-all duration-200 hover:translate-y-[-1px] hover:shadow-[0_4px_16px_rgba(15,23,42,0.12),0_2px_4px_rgba(15,23,42,0.08)] overflow-visible">
                                    ...
                                    <div className="px-8 pt-6 pb-4 border-b border-[#E2E8F0]/60">
                                        <span className="text-[9px] font-semibold text-[#4A5568] uppercase tracking-[0.18em]">Authentication</span>
                                    </div>
                                    ...
                                    {/* Header */}
                                    <div className="mb-8">
                                        <h1 className="text-[34px] font-bold text-[#1A1D2E] tracking-[-0.02em] leading-tight" style={{ fontFamily: 'var(--font-geist-sans)' }}>Sign in</h1>
                                        <p className="text-[15px] text-[#4A5568] mt-2">Access your learning dashboard</p>
                                    </div>

                                    {/* SSO - Hidden when waitlist mode is enabled */}
                                    {!waitlistModeEnabled && !checkingMode && (
                                        <>
                                            <button
                                                type="button"
                                    ...
                                    <form onSubmit={handleEmailPasswordLogin} className="space-y-5">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-right mt-2">
                                                <a href="/forgot-password" className="text-[13px] text-[#5A5FF0] hover:text-[#4A4FD0] font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-[#5A5FF0]/40 rounded px-1">
                                                    Forgot password?
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-7 pt-6 border-t border-[#E2E8F0] text-center">
                                            <p className="text-[14px] text-[#4A5568]">
                                                ...
                                                <a href="/signup" className="text-[#5A5FF0] hover:text-[#4A4FD0] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[#5A5FF0]/40 rounded px-1">
                                                    Sign up
                                                </a>
                                            </p>
                                        </div>

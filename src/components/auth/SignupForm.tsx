                    ...
                    <>
                      ...
                      <form onSubmit={handleValidateCode} className="space-y-6">
                        ...
                        <button
                          ...
                          className="w-full h-12 px-6 bg-[#5A5FF0] hover:bg-[#4A4FD0] text-white font-semibold text-[15px] rounded-xl transition-all duration-150 disabled:bg-[#E2E8F0] disabled:text-[#94A3B8] disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-[#5A5FF0]/40 focus:ring-offset-2"
                        >

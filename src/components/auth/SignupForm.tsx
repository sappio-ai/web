                      ...
                      <>
                        ...
                        <div className="mt-8 pt-6 border-t border-[#E2E8F0] space-y-4">
                          <div className="text-center">
                            <p className="text-[14px] font-semibold text-[#1A1D2E] mb-1">Don&apos;t have an invite code?</p>
                            <p className="text-[13px] text-[#64748B]">Join the waitlist to get early access.</p>
                          </div>

                          <a
                            href="/waitlist"
                            className="flex items-center justify-center w-full px-6 py-3.5 bg-white hover:bg-[#F8FAFB] text-[#1A1D2E] text-[15px] font-bold rounded-xl border-2 border-[#E2E8F0] hover:border-[#CBD5E1] transition-all duration-200 group"
                          >
                            Join Waitlist
